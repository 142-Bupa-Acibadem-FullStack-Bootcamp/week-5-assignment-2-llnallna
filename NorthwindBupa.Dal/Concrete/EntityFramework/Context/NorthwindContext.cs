...
namespace NorthwindBupa.Dal.Concrete.EntityFramework.Context

{
    public partial class NorthwindBupaContext : DbContext
    {
        ...
        public NorthwindBupaContext(DbContextOptions<NorthwindBupaContext> options)
            : base(options)
        {
        }
